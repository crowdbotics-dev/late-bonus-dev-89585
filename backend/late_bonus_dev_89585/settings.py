"""
Django settings for late_bonus_dev_89585 project.
...
ROOT_URLCONF = 'late_bonus_dev_89585.urls'
...
WSGI_APPLICATION = 'late_bonus_dev_89585.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "late_bonus_dev_89585 API",
    "DESCRIPTION": "API documentation for late_bonus_dev_89585 App",
    "VERSION": "v1",
}
